      ...
      contacts: [
        {
          ...
          number: "100",
          description: "For immediate police assistance in emergencies (India)"
        },
        {
          name: "Non-Emergency Police",
          number: "100", // General police emergency for non-specific inquiries, can be adapted
          description: "For non-emergency police matters and inquiries"
        },
        {
          name: "Crime Stoppers",
          number: "1090", // Women Helpline, for general crime reporting, can be adapted
          description: "Anonymous crime reporting hotline (India)"
        }
      ]
    },
    {
      ...
      contacts: [
        {
          name: "Fire Emergency",
          number: "101",
          description: "For fire emergencies and immediate rescue needs (India)"
        },
        {
          name: "Fire Prevention",
          number: "101", // Use same as emergency for simplicity or specific local number
      ...
      contacts: [
        {
          ...
          number: "102",
          description: "For life-threatening medical emergencies (Ambulance - India)"
        },
        {
          name: "Poison Control",
          number: "1078", // National Health Helpline or specific Poison Control India if available
          description: "24/7 poison emergency and information (India)"
        },
        {
          name: "Medical Helpline",
          number: "104", // General Health Helpline (India)
          description: "24/7 medical advice from healthcare professionals (India)"
        }
      ]
    }
  ];
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-red-600 dark:text-red-400">
              For any life-threatening emergency, immediately dial <span className="font-bold">100</span>. Don't delay calling emergency services
